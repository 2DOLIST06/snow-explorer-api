...
def _pdf_first_page(source, max_pages, max_dimension, max_pixels):
    """Rasterize one bounded PDF page with the pip-installed PDFium wheel."""
    import math
    ...
    try:
        try:
            # Password-protected files fail here when no password is supplied.
        ...
        try:
            ...
            # PDFium rounds raster dimensions up. Account for that before render.
