...
def create_app(config=None):
    ...
    app.config.update(
        ...
        ANMSM_PISTE_MAP_MAX_PIXELS=int(os.getenv("ANMSM_PISTE_MAP_MAX_PIXELS", "9000000")),
        ANMSM_PISTE_MAP_DISPLAY_MAX_DIMENSION=int(os.getenv("ANMSM_PISTE_MAP_DISPLAY_MAX_DIMENSION", "3000")),
        ANMSM_PISTE_MAP_DISPLAY_MAX_BYTES=int(os.getenv("ANMSM_PISTE_MAP_DISPLAY_MAX_BYTES", str(6 * 1024 * 1024))),
        ANMSM_PISTE_MAP_WEBP_QUALITY=int(os.getenv("ANMSM_PISTE_MAP_WEBP_QUALITY", "88")),
        ANMSM_PISTE_MAP_PDF_MAX_PAGES=1,
        ANMSM_CONVERSION_TIMEOUT=float(os.getenv("ANMSM_CONVERSION_TIMEOUT", "20")),
        ANMSM_CONVERSION_MEMORY_MB=int(os.getenv("ANMSM_CONVERSION_MEMORY_MB", "256")),
    )
    if config:
