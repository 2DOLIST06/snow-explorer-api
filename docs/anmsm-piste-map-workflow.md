...
rendus avec la roue Linux précompilée pypdfium2 dans le même processus enfant isolé que le
décodeur Pillow, jamais dans Gunicorn. pypdfium2 est installé par la commande de
